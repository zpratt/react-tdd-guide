...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var RootComponent = __webpack_require__(1),
	    ...
	    function start() {
	        ...
	        React.render(React.createElement(RootComponent, {users: users}), document.body.querySelector('.example'));
	    }
	        ...
	        return (
	            React.createElement("ul", null, 
	                this.props.users.map(function (user) {
	                    return (
	                        React.createElement("li", null, user.name)
	                    );
	                })
	            )
	        );
